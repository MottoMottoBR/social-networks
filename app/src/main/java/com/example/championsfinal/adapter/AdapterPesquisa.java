package com.example.championsfinal.adapter;
...
public class AdapterPesquisa extends RecyclerView.Adapter<AdapterPesquisa.MyViewHolder> {
    ...
    public AdapterPesquisa(List<Users> l, Context c) {
        this.listaUsuario = l;
        this.context = c;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Users usuario = listaUsuario.get(position);


        holder.nome.setText(usuario.getNome());
        holder.user.setText(usuario.getUserNome());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            user = itemView.findViewById(R.id.txtUserPesquisa);
